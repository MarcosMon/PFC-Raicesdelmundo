...
class KpiController{
    ...
    public async listMyMuseumsKPI(req: Request, res: Response): Promise<any> {
        ...
        await pool.query("SELECT  k.id, m.name, k.webVisitClicks, k.webTicketBuy, m.user_id from kpi as k INNER JOIN museums as m ON k.id_museum = m.id where  k.id_museum= " + id , 
